...
<body>
    ...
    <div class="title-text" style="font-size: 13px;">
        Diberikan Kepada Pasien Berikut :
    </div>
    ...
    <div class="section-body">
        <div class="paragraph-text">
            Berdasarkan hasil konsultasi medis, pasien diberikan resep obat-obatan sebagai berikut. Harap diminum/digunakan sesuai dosis dan instruksi yang tertera.
        </div>
        
        <table style="width: 100%; border-collapse: collapse; font-size: 11px; margin-top: 10px;">
            <thead>
                <tr style="border-bottom: 2px solid #87b0b0;">
                    <td style="padding: 5px 10px; text-align: left; font-weight: bold; color: #1a4a4d; width: 25%;">Nama Obat</td>
                    <td style="padding: 5px 10px; text-align: left; font-weight: bold; color: #1a4a4d; width: 25%;">Kegunaan</td>
                    <td style="padding: 5px 10px; text-align: left; font-weight: bold; color: #1a4a4d; width: 25%;">Dosis</td>
                    <td style="padding: 5px 10px; text-align: left; font-weight: bold; color: #1a4a4d; width: 25%;">Catatan</td>
                </tr>
            </thead>
            <tbody>
        ...
        <tr>
            <td style="width: 50%; vertical-align: top;">
                <div style="font-size: 11px; color: #1a4a4d; line-height: 1.4; margin-bottom: 40px;">
                   Resep obat hanya bisa dipakai 1x dan berlaku maksimal 1 minggu setelah penerbitan surat.
                </div>
                
                <div style="font-size: 10px; color: #1a4a4d; font-weight: bold; line-height: 1.3;">
                    Resep ini sudah diverifikasi secara elektronik,<br>
