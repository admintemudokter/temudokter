...
<body>
            ...
            <td style="width: 70%; vertical-align: bottom; padding-bottom: 5px;">
                <table style="width: 100%; font-size: 11px; color: #000; border-collapse: collapse;">
                    ...
                    <tr>
                        ...
                        <td style="text-align: left; padding-left: 10px; white-space: nowrap;">{{ $doctor->sip_number ?? '-' }}</td>
                    </tr>
                </table>
            </td>
        </tr>
    ...
    <div style="text-align: center; font-weight: bold; font-size: 18px; color: #1a4a4d; letter-spacing: 1px; margin-bottom: 20px;">
        LAPORAN TINDAKAN MEDIS (HOMECARE)
    </div>

    <div class="title-text" style="font-size: 13px;">
        Tindakan diberikan kepada pasien :
    </div>
    ...
    <div class="section-body">
        <div class="paragraph-text">
            Berdasarkan hasil kunjungan Homecare, pasien diberikan tindakan medis atau layanan sebagai berikut:
        </div>
        
        <table style="width: 100%; border-collapse: collapse; font-size: 11px; margin-top: 10px;">
            <thead>
                <tr style="border-bottom: 2px solid #87b0b0;">
                    <td style="padding: 5px 10px; text-align: left; font-weight: bold; color: #1a4a4d; width: 40%;">Nama Tindakan</td>
                    <td style="padding: 5px 10px; text-align: left; font-weight: bold; color: #1a4a4d; width: 30%;">Bentuk Sediaan / Tipe</td>
                    <td style="padding: 5px 10px; text-align: left; font-weight: bold; color: #1a4a4d; width: 30%;">Biaya/Harga</td>
                </tr>
            </thead>
            <tbody>
                @foreach($consultation->treatments as $treatment)
                <tr style="border-bottom: 1px solid #87b0b0;">
                    <td style="padding: 10px; font-weight: bold;">{{ $treatment->treatment_name }}</td>
                    <td style="padding: 10px;">{{ $treatment->bentuk_sediaan ?: '-' }}</td>
                    <td style="padding: 10px;">Rp {{ number_format($treatment->price, 0, ',', '.') }}</td>
                </tr>
                @endforeach
            </tbody>
        </table>
        ...
        <tr>
            <td style="width: 50%; vertical-align: top;">
                <div style="font-size: 11px; color: #1a4a4d; line-height: 1.4; margin-bottom: 40px;">
                   Laporan tindakan ini merupakan bukti sah layanan yang telah diberikan kepada pasien.
                </div>
                
                <div style="font-size: 10px; color: #1a4a4d; font-weight: bold; line-height: 1.3;">
                    Laporan ini sudah diverifikasi secara elektronik,<br>
