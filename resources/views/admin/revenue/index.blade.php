...
@section('page_subtitle', 'Ringkasan dan riwayat pendapatan finansial Temu Dokter')
    ...
    <div class="card-body border-b border-slate-100 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        ...
        <div class="flex flex-col sm:flex-row items-center gap-3 w-full md:w-auto">
            ...
            <div class="flex items-center gap-2">
                ...
                <form action="{{ route('admin.revenue.reset') }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus SEMUA data pendapatan dan riwayat konsultasi? Tindakan ini akan mengembalikan pendapatan menjadi Rp 0 dan TIDAK BISA dibatalkan!');">
                    @csrf
                    @method('DELETE')
                    <button type="submit" class="bg-rose-600 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-rose-700 transition-colors flex items-center gap-2">
